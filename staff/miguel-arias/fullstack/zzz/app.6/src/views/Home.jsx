...
function Home(props) {
    ...
    return <>
        ...
        <main>
            {view === 'profile' && <Profile onSuccess={handleChangeUserData} onError={props.onError} />}
        ...
        <footer>
            {view === 'new-post' && <NewPost onSuccess={handleNewPostPublish} onCancel={handleNewPostCancel} onError={props.onError} />}
