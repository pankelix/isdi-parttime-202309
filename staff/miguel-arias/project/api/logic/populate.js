...
(async () => {
    try {
        ...
        let john
        try {
            peter = await registerProfile('Peter Pan', '1234', 'green', 'admin')
            wendy = await registerProfile('Wendy Darling', '1234', 'blue', 'admin')
            michael = await registerProfile('Michael Darling', '1234', 'white')
            john = await registerProfile('John Darling', '1234', 'pink')
        } catch (error) {
            console.log(error)
        }
